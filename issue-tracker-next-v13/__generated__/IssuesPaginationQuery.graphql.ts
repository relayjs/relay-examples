/**
 * @generated SignedSource<<aa722b65c763b7cdc0f2265dfcc1b0b8>>
...
export type IssuesPaginationQuery$variables = {
  ...
  id: string;
  states?: ReadonlyArray<IssueState> | null | undefined;
};
...
return {
  ...
  "params": {
    "cacheID": "bf29ad2ed98b6639546477c530952d79",
    "id": null,
    "metadata": {},
    "name": "IssuesPaginationQuery",
    "operationKind": "query",
    "text": "query IssuesPaginationQuery(\n  $count: Int = 10\n  $cursor: String\n  $states: [IssueState!] = OPEN\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...IssuesFragment_a4QoT\n    id\n  }\n}\n\nfragment IssuesFragment_a4QoT on Repository {\n  issues(after: $cursor, first: $count, states: $states) {\n    edges {\n      node {\n        title\n        number\n        author {\n          __typename\n          login\n          ... on Node {\n            __isNode: __typename\n            id\n          }\n        }\n        id\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n  id\n}\n"
  }
};
})();
