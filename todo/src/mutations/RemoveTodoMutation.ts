import type {RemoveTodoMutation_todo$key} from '../__generated__/RemoveTodoMutation_todo.graphql.ts';
import type {RemoveTodoMutation_user$key} from '../__generated__/RemoveTodoMutation_user.graphql.ts';
