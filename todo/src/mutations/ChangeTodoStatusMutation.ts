import type {ChangeTodoStatusMutation_todo$key} from '../__generated__/ChangeTodoStatusMutation_todo.graphql.ts';
import type {ChangeTodoStatusMutation_user$key} from '../__generated__/ChangeTodoStatusMutation_user.graphql.ts';
