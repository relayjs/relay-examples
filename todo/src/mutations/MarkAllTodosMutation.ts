import type {MarkAllTodosMutation_user$key} from '../__generated__/MarkAllTodosMutation_user.graphql.ts';
import type {MarkAllTodosMutation_todoEdge$key} from '../__generated__/MarkAllTodosMutation_todoEdge.graphql.ts';

import {useCallback} from 'react';
import {graphql, useFragment, useMutation} from 'react-relay';

const mutation = graphql`
  mutation MarkAllTodosMutation($input: MarkAllTodosInput!) @catch {
