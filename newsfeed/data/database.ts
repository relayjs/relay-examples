...
export type NodeRow = PersonRow | OrganizationRow | StoryRow;
...
const nodes: NodeRow[] = [
  ...
  },
  {
    ...
    attachments: [{ url: "/assets/yak.png" }],
    thumbnail: {
      url: "/assets/yak.png",
    ...
    comments: [
      { id: "comment1", text: "So proud of our local yak" },
      { id: "comment2", text: "I've been waiting my whole life for this moment" },
      { id: "comment3", text: "What's a yak???" },
      { id: "comment4", text: "We used to keep yaks in the old country" },
      { id: "comment5", text: "It's a yak attack, this award is whack" },
      { id: "comment6", text: "There are better yaks in every pasture of this country" },
      { id: "comment7", text: "Yak yak yak yak yak yak yak yak" },
      { id: "comment8", text: "He's a good yak, he saved my child from drowning" },
    ],
  },
  {
    __typename: "Story",
    ...
    authorID: "1",
    createdAt: "2020-01-01T00:00:00.000Z",
    attachments: [{ url: "/assets/chicken.png" }],
    thumbnail: { url: "/assets/chicken.png" },
    likeCount: 2,
    doesViewerLike: false,
    comments: [
      { id: "comment9", text: "I never knew!" },
      { id: "comment10", text: "This is a very deep joke." },
    ],
  },
  {
    __typename: "Story",
    ...
    authorID: "6",
    createdAt: "2020-01-01T00:00:00.000Z",
    attachments: [{ url: "/assets/hedgehog.png" }],
    thumbnail: { url: "/assets/hedgehog.png" },
    likeCount: 160,
    doesViewerLike: false,
    comments: [{ id: "comment11", text: "Aren't hedges dark though???" }],
  },
  {
    __typename: "Story",
    id: "99",
    ...
    authorID: "30",
    createdAt: "2020-01-01T00:00:00.000Z",
    attachments: [{ url: "/assets/puzzled_egg.png" }],
    thumbnail: { url: "/assets/puzzled_egg.png" },
    likeCount: 17,
    doesViewerLike: false,
    comments: [{ id: "comment13", text: "Wait..." }],
  },
  {
    __typename: "Person",
    id: "30",
    name: "Brock Boc",
    profilePicture: { url: "/assets/chicken_lover.png" },
    joined: "2017-04-02T00:00:00.000Z",
    location: { id: "31", name: "Paradoxopolus" },
  },
  {
    __typename: "Story",
    id: "5",
    ...
    authorID: "8",
    createdAt: "2020-01-01T00:00:00.000Z",
    attachments: [{ url: "/assets/recipe.png" }],
    thumbnail: { url: "/assets/recipe.png" },
    likeCount: 12,
    doesViewerLike: false,
    comments: [
      {
  ...
  },
  {
    ...
    authorID: "9",
    createdAt: "2020-01-01T00:00:00.000Z",
    attachments: [{ url: "/assets/cat.png" }],
    thumbnail: { url: "/assets/cat.png" },
    likeCount: 12,
    doesViewerLike: false,
    comments: [],
  },
  {
    ...
    profilePicture: { url: "/assets/gazelle.png" },
    joined: "2020-01-01T00:00:00.000Z",
  ...
  },
  {
    ...
    id: "8",
    name: "Suzie Queue",
    profilePicture: { url: "/assets/blogger.png" },
    joined: "2020-01-01T00:00:00.000Z",
    location: { id: "11", name: "Venice" },
  },
  {
    __typename: "Person",
    id: "15",
    name: "Jennifer Letuchyberg",
    profilePicture: { url: "/assets/j.png" },
    joined: "2020-01-01T00:00:00.000Z",
    location: { id: "16", name: "Zig Zag" },
  },
  {
    __typename: "Person",
    id: "13",
    name: "Alexei Seligsteinwitz",
    profilePicture: { url: "/assets/alexei.png" },
    joined: "2020-01-01T00:00:00.000Z",
    location: { id: "14", name: "Mystery" },
  },
  {
    __typename: "Person",
    id: "19",
    name: "Catalina Chaiman",
    profilePicture: { url: "/assets/c.png" },
    joined: "2020-01-01T00:00:00.000Z",
    location: { id: "20", name: "Weed" },
  },
  {
    __typename: "Person",
    id: "9",
    name: "Katrina Starer",
    profilePicture: { url: "/assets/cat_avatar.png" },
    joined: "2020-01-01T00:00:00.000Z",
    location: { id: "12", name: "New York" },
  },
  {
    __typename: "Person",
    id: "17",
    name: "Paige Talaberg",
    profilePicture: { url: "/assets/p.png" },
    joined: "2020-01-01T00:00:00.000Z",
    location: { id: "18", name: "Boring" },
  },
  {
    __typename: "Person",
    id: "21",
    name: "Huy Li",
    profilePicture: { url: "/assets/h.png" },
    joined: "2020-01-01T00:00:00.000Z",
    location: { id: "22", name: "Cave Junction" },
  },
];

export function findNode(id: string): NodeRow | undefined {
  return nodes.find((node) => node.id === id);
}

export function getStories(): StoryRow[] {
  return nodes.filter((n): n is StoryRow => n.__typename === "Story");
}

export function getPersons(): PersonRow[] {
  return nodes.filter((n): n is PersonRow => n.__typename === "Person");
}

export function getViewer(): PersonRow {
  return nodes.find((n): n is PersonRow => n.id === "the-viewer")!;
}

export function getNonViewerPersons(): PersonRow[] {
  return nodes.filter(
    (n): n is PersonRow => n.__typename === "Person" && n.id !== "the-viewer",
  );
}

let nextCommentID = 0;

export function likeStory(
  id: string,
  doesLike: boolean,
): StoryRow | undefined {
  const story = nodes.find(
    (n): n is StoryRow => n.__typename === "Story" && n.id === id,
  );
  if (!story) return undefined;
  story.likeCount += (doesLike ? 1 : 0) - (story.doesViewerLike ? 1 : 0);
...
export function postComment(
  storyId: string,
  text: string,
): { story: StoryRow; commentId: string } | undefined {
  const story = nodes.find(
    (n): n is StoryRow => n.__typename === "Story" && n.id === storyId,
  );
  if (!story) return undefined;
  const commentId = `posted-comment-${nextCommentID++}`;
  story.comments.unshift({ id: commentId, text });
  return { story, commentId };
}
